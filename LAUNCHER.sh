...
python Aggregation_Sampling.py --noise_schedule="cosine" --snapshot_name=snapshot.pt --image_size=256 --batch_size=32 --noise_steps=1000 --model_name="Residual_Attention_UNet_superres_magnification4_LRimgsize64_up42_sentinel2_patches_downblur_StableDiffusion_LRandHR_gradientAccumulation" --UNet_type="Residual Attention UNet" --Degradation_type="DownBlur" --magnification_factor=4 --inp_out_channels=4 --destination_path="rgb_60m_SR.png" --img_lr_path="rgb_60m.png" --VAE_weight_path="VAE_up42_LRandHR_finetuning_gradientAccumulation"
