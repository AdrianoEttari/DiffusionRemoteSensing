...
python3 train_diffusion_superres.py --epochs=1 --batch_size=4 --image_size=256 --lr=1e-4 --lr_schedule='cosine' --noise_schedule="cosine" --snapshot_name=snapshot.pt --model_name="$model_name" --noise_steps=1000 --patience=25  --dataset_path="$dataset_path" --inp_out_channels=4 --loss="MSE" --magnification_factor=4 --UNet_type="Residual Attention UNet" --Degradation_type="DownBlur" --multiple_gpus="False" --ema_smoothing="False" --Blur_radius=0.5 --VAE_weight_path="$VAE_model_name"
