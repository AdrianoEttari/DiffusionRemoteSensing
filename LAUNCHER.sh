...
python3 StableDiff_LatentDiffusion.py --image_size=192 --magnification_factor=4 --Degradation_type="DownBlur" --multiple_gpus="False" --Blur_radius=0.5 --vae_snapshot_name="VAE_finetuning_MSE_Perceptual" --diffusion_snapshot_name="Diffusion_finetuning" 
