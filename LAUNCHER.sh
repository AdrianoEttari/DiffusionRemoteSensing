...
VAE_model_name="VAE_up42_LRandHR_finetuning_gradientAccumulation_magn2.pt"
...
python train_diffusion_superres.py --dataset_path="$dataset_path" --model_name="$model_name" --Degradation_type="DownBlur" --image_size=256 --magnification_factor=2 --Blur_radius=0.5 --num_crops=1 --batch_size=4 --multiple_gpus=False --VAE_weight_path="$VAE_model_name" 

###### DIFFUSION TRAINING ######
# dataset_path="celebA_50k_VAE_encoded"
# dataset_path="up42_sentinel2_patches_VAE_encoded"
# python train_diffusion_superres.py --VAE_weight_path="$VAE_model_name" --model_name="$model_name" --snapshot_name=snapshot.pt --noise_steps=1000 --ema_smoothing=False --magnification_factor=2 --UNet_type="Residual Cross Attention UNet" --inp_out_channels=4 --batch_size=16 --image_size=256 --multiple_gpus=False --noise_schedule="cosine" --dataset_path="$dataset_path" --lr=1e-3 --epochs=201 --check_preds_epoch=5 --patience=25  --loss="MSE" --lr_schedule="cosine" --Degradation_type="DownBlur" --Blur_radius=0.5
...
# python Aggregation_Sampling.py --noise_schedule="cosine" --snapshot_name=snapshot.pt --image_size=256 --patch_size=128 --noise_steps=1000 --model_name="$model_name" --UNet_type="Residual Cross Attention UNet" --Degradation_type="DownBlur" --batch_dataloader_size=32 --magnification_factor=2 --inp_out_channels=4 --destination_path="rgb_20m_SR.png" --img_lr_path="rgb_20m.png" --VAE_weight_path="$VAE_model_name"
